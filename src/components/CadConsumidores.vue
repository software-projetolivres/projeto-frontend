          ...
          <form id="formCadConsumidores">
            ...
            <div class="md-form">
              <input
                ...
                id="email"
                class="form-control"
                v-model.trim="consumidor.email"
              />
              <label :class="{ active: preenchido }" for="email">E-mail</label>
            </div>
  ...
  methods: {
    ...
    AdicionarConsumidor: function() {
      if (this.consumidor.senha == "") {
        ...
        const consumidor = this.consumidor;
        delete consumidor.precomunidade;
        Consumidores.inserir(consumidor)
          .then(() => {
    ...
    AlterarConsumidor: function() {
        const id = this.consumidorAlterar.id;
        Consumidores.alterar({...this.consumidor, id})
        .then(() => {
