...
export default {
  ...
  created() {
    const that = this;
    loja.listarCarrinhos().then(() => {
        loja.getProdutosDisponiveisVendaByCategoria().then(response => {
  ...
  methods: {
    buscarProdutosPorPagina() {
      const that = this;
      loja.listarCarrinhos('a8a2d198-37b7-49f8-86b0-0a1ed4287441').then(() => {
        loja
          .getProdutosDisponiveisVendaByCategoria('a8a2d198-37b7-49f8-86b0-0a1ed4287441', that.currentPage)
          .then(response => {
            that.produtos = response.data.produtos;
            that.produtos.map(
              p =>
    ...
    updateCarrinho(produto) {
      const that = this;
      loja.sincronizarProduto('a8a2d198-37b7-49f8-86b0-0a1ed4287441', produto.cotacaoId, produto.qtd).then(() => {
